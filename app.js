...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const words = ["Network Engineer", "Cloud Solutions Architect", "Cybersecurity Specialist", "Computers & Information Graduate"];
    let i = 0;
    let timer;
    ...
    const commands = {
        ...
        skills: [
            "<span class='highlight-cmd'>[NETWORKING PROTOCOLS & TOOLS]</span>",
            "  - Core Specs: CCNA, CCNP Basics",
            ...
            "  - AWS Services: IAM, S3, RDS, Cloud Security Configurations",
            "  - Hypervisors: Virtualization Core",
            "",
        ...
        about: [
            "Mahmoud Maher Elhwery - Network & Cloud Security Engineer",
            "Located in: Tanta, Egypt",
            "Bachelor of Computers & Information (Grade: Very Good, Class of 2026)",
            "Detailed oriented builder focused on designing scalable architectures and secure infrastructures."
        ]
    };
    ...
    function runTracerouteSimulator() {
        const tracerouteSteps = [
            ...
            " <span class='highlight-cmd'>5</span>  mahmoud-maher (192.168.10.10) [AS1004]  0.560 ms [Target Reached - Fully Qualified Network Engineer]"
        ];
